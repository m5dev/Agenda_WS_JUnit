...
public class StoreLDateModelSelectTest {
	...
	protected void initializeSelectRecord() {
		...
		StoreLDateInfo infoRecord = new StoreLDateInfo();
		...
		model = new StoreLDateModelSelect(infoRecord);
	}
	...
	private void initializeNullArgument() {
		PowerMockito.when(DbConnection.getConnection()).thenReturn(selectConn);
		model = new StoreLDateModelSelect(null);
	}
